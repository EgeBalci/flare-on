...
print("[*] Filling map...")
dword_71580_z3 = Array('dword_71580_z3', BitVecSort(64), BitVecSort(64))
...
def stage_3():
    v1 = ((flag_input[8] + 0x01) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v1 = {hex(v1)}")
    v2 = (((flag_input[9] + v1)) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v2 = {hex(v2)}")
    v3 = ((v1 + v2) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v3 = {hex(v3)}")
    v4 = ((flag_input[10] + v2) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v4 = {hex(v4)}")
    v5 = ((v4 + v3) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v5 = {hex(v5)}")
    v6 = ((flag_input[11] + v4) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v6 = {hex(v6)}")
    v7 = ((v6 + v5) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v7 = {hex(v7)}")
    v8 = ((flag_input[12] + v6) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v8 = {hex(v8)}")
    v9 = ((v8 + v7) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v9 = {hex(v9)}")
    v10 = ((flag_input[13] + v8) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v10 = {hex(v10)}")
    v11 = ((v10 + v9) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v11 = {hex(v11)}")
    v12 = ((flag_input[14] + v10) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v12 = {hex(v12)}")
    v13 = ((v12 + v11) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v13 = {hex(v13)}")
    v14 = ((flag_input[15] + v12) % 0xFFF1) & 0xFFFFFFFF
    # print(f"v14 = {hex(v14)}")
...
def stage_5():
  result = 0xFFFFFFFF
  for i in range(0,16):
    result = (dword_71580_z3[(flag_input[i] & 0xFF)  ^ ((result >> 24) & 0xFFFFFFFFFFFFFFFF)] ^ ((result << 8) & 0xFFFFFFFF)) & 0xFFFFFFFF
  return result



print("[*] Setting up solver constraints...")
flag_input = Array('flag_input', BitVecSort(64), BitVecSort(64))
for i in range(0,16):
