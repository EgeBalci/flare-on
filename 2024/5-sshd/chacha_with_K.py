...
ciphertext = bytes.fromhex('A9F63408422A9E1C0C03A8089470BB8DAADC6D7B24FF7F247CDA839E92F7071D0263902EC158')
...
plain = chacha20_encrypt(key, counter, nonce, ciphertext)
print("Encrypted Message:",plain)